...
def home_view(request):
    ...
    candlestick_path = os.path.join(settings.BASE_DIR, 'saved_states', 'images', f'{stock}_candlestick_chart.png')
    ...
    context['candlestick_image'] = f"/media/{stock}_candlestick_chart.png" if os.path.exists(candlestick_path) else None
        ...
        try:
            ...
            if result.get('status') == 'skip':
                ...
                context.update({
                    ...
                    'candlestick_image': result.get('candlestick_image'),
...
def chat_view(request):
    ...
    """
    return render(request, 'app/chatpage.html')
